...
def main():
    time_str = "_".join(str(datetime.now()).split(".")[0].split(" "))
    ...
    parser.add_argument('--log', type=str, default=f'data/track_log_{time_str}.csv',
                       help='Path to log file (default: data/track_log_TIME.csv)')
    ...
    if not args.backtrack:
        ...
        try:
            ...
            print("\n👋 Stopping tracker...")
            print(tracker.object_history.timeline, tracker.object_history.id)
        finally:
